...
public class ClientControllerTests : IClassFixture<CustomWebApplicationFactory>
{
    ...
    {
        var dto = new CreateClientDto("TestUser", "testuser@example.com", "Pass1!", "Av. Test 1", "910000001");
        ...
        clients.Should().Contain(c => c.Email == "testuser@example.com");
    }
    ...
    {
        var dto = new CreateClientDto("NewClient", "newclient@example.com", "Secure1!", "Rua Nova 5", "920000001");
        ...
        result!.Name.Should().Be("NewClient");
        result.Email.Should().Be("newclient@example.com");
    }

    [Fact]
    public async Task Create_ResponseDoesNotContainPasswordHash()
    {
        var dto = new CreateClientDto("SecureUser", "secure@example.com", "S3cr3t!", "Rua Segura 1", "930000001");
    ...
    {
        var dto = new CreateClientDto("Dup", "dup@example.com", "Pass1!", "Rua Dup 1", "940000001");
