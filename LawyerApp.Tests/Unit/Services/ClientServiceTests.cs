...
public class ClientServiceTests
{
    ...
    public async Task CreateClientAsync_WhenEmailIsNew_ReturnsClientDto()
    {
        ...
        _userRepoMock.Setup(r => r.EmailExistsAsync(dto.Email, It.IsAny<CancellationToken>())).ReturnsAsync(false);
        ...
        _userRepoMock
            ...
            .ReturnsAsync((CreateClientDto c, CancellationToken _) => new Client(c.Name, c.Email, c.Password, c.BillingAddress, c.PhoneNumber));
    ...
    public async Task CreateClientAsync_WhenEmailAlreadyExists_ReturnsFailure()
    {
        ...
        _userRepoMock.Setup(r => r.EmailExistsAsync(dto.Email, It.IsAny<CancellationToken>())).ReturnsAsync(true);
    ...
    public async Task CreateClientAsync_HashesPasswordBeforePersisting()
    {
        ...
        _userRepoMock.Verify(
            r => r.AddClientAsync(It.Is<CreateClientDto>(c => c.Password == hashed), It.IsAny<CancellationToken>()),
            Times.Once);
    }
    ...
    public async Task CreateClientAsync_NeverStoresPlainTextPassword()
    {
        ...
        _userRepoMock.Verify(
            r => r.AddClientAsync(It.Is<CreateClientDto>(c => c.Password == "PlainText"), It.IsAny<CancellationToken>()),
            Times.Never);
    }
    ...
    public async Task GetAllClientsAsync_ReturnsMappedDtos()
    {
        ...
        _userRepoMock.Setup(r => r.GetAllClientsAsync(It.IsAny<CancellationToken>())).ReturnsAsync(clients);
    ...
    {
        _userRepoMock.Setup(r => r.GetAllClientsAsync(It.IsAny<CancellationToken>())).ReturnsAsync(new List<Client>());
