...
| **Analysis** | **10%** | System Overview, Domain Model, Architecture |  | Full tech stack description and domain model identifying all major system components. |
...
| **Requirements** | **20%** | Security Reqs (Auth, Data, Input) |  | Justified requirements covering the 6 core pillars (Auth, Access, Data, Input, 3rd Party, Logging). |
